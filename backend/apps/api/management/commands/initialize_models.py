...
from apps.api.models import Method, Electrode, Instrument, VoltammetryTechnique
        ...
        try:
            with transaction.atomic():
                ...
                for technique_name in techniques:
                    VoltammetryTechnique.objects.get_or_create(name=technique_name)
                self.stdout.write(self.style.SUCCESS(f'Created {len(techniques)} default voltammetry techniques'))
